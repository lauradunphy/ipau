...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "lauradunphy/ipau" ]]; then
...
echo "Your new report will be visible at https://lauradunphy.github.io/ipau in a moment."
